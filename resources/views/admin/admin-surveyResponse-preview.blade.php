...
<head>
    ...
    <title>KIMS | Admin Survey-Response Preview</title>
                        ...
                        <div class="ml-auto text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{route('ad.responses')}}">Survey-Response</a></li>

                                    <li class="breadcrumb-item active" aria-current="page">Response Preview</li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h4 class="card-title m-b-0">Responses Preview for Module Id <?php echo $id; ?></h4>
                                ...
                                <div class="row manage">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered">
                                          <tr align="center">
                                            <th colspan="2"><b>Responses</b></th>
                                          </tr>
                                          <tr align="center">
                                            <th width="75%"><b>Questions</b></th>
                                            <th ><b>Answers (Avg of scales 1-5 options)</b>
                                            </th>
                                          </tr>
                                          <tr>
                                            @foreach($value as $v)
