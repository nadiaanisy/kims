...
<head>
    ...
    <title>KIMS | Admin Survey-Question Manager</title>
...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="card-title m-b-0"> Survey {{$survey->surveyname}}</h4>
                                        <div class="float-right">
                                            <button type="button" class="btn btn-outline-primary">Manage Question</button>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-bordered">
                                            <tr>
                                                <th width="20%"><b>SURVEY NAME</b></th>
                                            ...
                                            <tr align="center">
                                                <th scope="col" colspan="2"><b>QUESTION(S) ASSOCIATED</b></th>
                                            </tr>
                                            <tr>
                                                <th scope="col" bgcolor="#D3D3D3"><b>EVENT</b></th>
                                                <td scope="col">
                                                    <?php $kira = 1;?>
                                                    @foreach($question as $quest)
                                                        @if($quest->typequest == 'EVENT' && $quest->view_status == 'enable')
                                                            <?php 
                                                                echo $kira . ". ";
                                                                $kira++; 
                                                            ?> 
                                            ...
                                            <tr>
                                                <th scope="col" bgcolor="#D3D3D3"><b>FACILITATOR</b></th>
                                                <td scope="col">
                                                    <?php $kira = 1;?>
                                                    @foreach($question as $quest)
                                                        @if($quest->typequest == 'FACILITATOR' && $quest->view_status == 'enable')
                                                            <?php 
                                                                echo $kira . ". ";
                                                                $kira++; 
                                                            ?> 
                                            ...
                                            <tr>
                                                <th scope="col" bgcolor="#D3D3D3"><b>MODULE</b></th>
                                                <td scope="col">
                                                    <?php $kira = 1;?>
                                                    @foreach($question as $quest)
                                                        @if($quest->typequest == 'MODULE' && $quest->view_status == 'enable')
                                                            <?php 
                                                                echo $kira . ". ";
                                                                $kira++; 
                                                            ?> 
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="card-title m-b-0">Manage Question</h4>
                                    </div>
                                </div>
                                <br>
                                <div class="row manage">
                                    <div class="col-md-12">
                                        <form method="POST" action="{{ action('AdminSurveyController@surveyQuestionUpdate', $survey->id) }}">
                                            {{ csrf_field() }}  
                                            <table class="table table-bordered">
                                                <tr align="center">
                                                    <th scope="col" colspan="2"><b>QUESTION</b></th>
                                                </tr>
                                                <tr>
                                                    <th scope="col" bgcolor="#D3D3D3"><b>EVENT</b></th>
                                                    <td scope="col">
                                                        <?php $kira = 1;?>
                                                        @foreach($allQ as $aq)
                                                            @if($aq->typequest == 'EVENT')
                                                                <?php $class = ''; ?>
                                                                @foreach($question as $q)
                                                                    @if($aq->id == $q->qid && $q->view_status == 'enable')
                                                                        <?php 
                                                                            $class='checked="true"';
                                                                        ?>
                                                                        @break
                                                                    @else
                                                                        <?php
                                                                            if($class != 'checked="true"')
                                                                                $class = '';
                                                                        ?>
                                                                    @endif
                                                                @endforeach
                                                                <input type="checkbox" name="cbE[]" value="{{$aq->id}}" <?php echo $class;?>  >
                                                                <?php
                                                                    echo $kira . ". ";
                                                                    $kira++; 
                                                                ?> 
  ...
  <script type="text/javascript">
  	...
  	{ 
        var lable = $(".btn-outline-primary").text().trim();

	   if(lable == "Hide") {
	     $(".btn-outline-primary").text("Manage Question");
	     $("#manage").hide();
	   }
	   else {
	     $(".btn-outline-primary").text("Hide");
	     $("#manage").show();
	   } 
  	});
  </script>
